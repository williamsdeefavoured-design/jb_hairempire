        ...
        <div className="grid md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            <p className="mt-4 text-sm text-muted-foreground max-w-sm leading-relaxed">
              A modern luxury house for hair. Hand-crafted wigs, professional styling tools and
              elevated treatments — designed for women who expect more.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li>
                <a href="/shop?category=wigs" className="hover:text-foreground">
                  Wigs
                </a>
              </li>
              <li>
                <a href="/shop?category=equipment" className="hover:text-foreground">
                  Equipment
                </a>
              </li>
              <li>
                <a href="/shop?category=treatment" className="hover:text-foreground">
                  Treatments
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li>
                <Link to="/tips" className="hover:text-foreground">
                  Tips & Guides
                </Link>
              </li>
              <li>
