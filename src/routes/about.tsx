  ...
  head: () => ({
    meta: [
      { title: "About" },
      {
        name: "description",
        content:
          "A modern luxury hair house — hand-crafted wigs, atelier-grade tools and elevated treatments.",
      },
    ],
  }),
  component: About,
    ...
    <div>
      <section className="mx-auto max-w-4xl px-6 lg:px-10 py-24 md:py-32 text-center">
        ...
        <p className="mt-10 text-lg text-foreground/70 leading-relaxed">
          We were founded on a simple belief: hair should feel like couture. From the raw bundles we
          source, to the artisans who hand-tie every cap, to the tools that finish the look — every
          detail is considered, refined and made to last.
        </p>
      </section>

      <section className="mx-auto max-w-7xl px-6 lg:px-10 pb-24">
        <div className="aspect-[16/9] overflow-hidden bg-cream">
          <img src={collection} alt="Our atelier" className="w-full h-full object-cover" />
        </div>
      </section>
      ...
      <section className="mx-auto max-w-5xl px-6 lg:px-10 pb-32 grid md:grid-cols-3 gap-12">
        {[
          ...
          {
            t: "Ethically sourced",
            c: "Raw hair from trusted donors, traceable from origin to atelier.",
          },
          { t: "Made to last", c: "With care, our pieces stay couture for years." },
        ].map((b) => (
          <div key={b.t}>
